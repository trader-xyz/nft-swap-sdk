...
import { SupportedTokenTypes, UserFacingSerializedSingleAssetDataTypes } from './order'
...
const encodeAssetData = (assetData: UserFacingSerializedSingleAssetDataTypes): string => {
  switch (assetData.type) {
    case SupportedTokenTypes.ERC20:
      const erc20AssetData = assetDataUtils.encodeERC20AssetData(assetData.tokenAddress)
...
const getAmountFromAsset = (assetData: UserFacingSerializedSingleAssetDataTypes): string => {
  switch (assetData.type) {
    case SupportedTokenTypes.ERC20:
